        ...
        <div className="container-fluid  mt-4 ">
          <div className="row ml-lg-4 d-flex justify-content-between contact-flex">
            <div className="col-lg-5 col-md-12 mt-md-1 ml-lg-4 col-sm-12">
              <p className="text-center  contact-touch" style={{ color: 'white' }}>Let's get in touch</p>
              ...
              <p className="text-center">
                ...
                <div className="row mt-4">
                  ...
                  <div className="col text-left ">
                    <p style={{ color: 'white' }}>
                      Shree Sai O2 Nutrition, Club Rd, Samta Budh Vihar, Pocket 2,
                      Paschim Puri, Paschim Vihar, Delhi, 110063
                    </p>
                  </div>
                </div>
                ...
                <div className="row mt-2">
                  ...
                  <div className="col text-left mt-2">
                    <p style={{ color: 'white' }}>+91 9494979191</p>
                  </div>
                </div>
                ...
                <div className="row mt-3">
                  ...
                  <div className="col text-left mt-2">
                    <p>
                      <a href="" className="contact-a" style={{ color: 'white' }}>
                        care@buildmybody.in
                      </a>
                    </p>
                  </div>
                ...
                <p className="text-center contact-issue mt-4 ml-4" style={{ color: 'white' }}>
            ...
            <div className="col col-md-12 col-lg-6 mt-md-4 mt-lg-0 mt-sm-4 helo">
              <p className="contact-get text-center mr-5" style={{ color: 'white' }}> Get in touch</p>
              <div className="contact-info  mt-4 ">
                <div className="contact-full-name ">
                  <div className="row   ">
                    <div className="col  ">
                      <p className="text-left contact-name" style={{ color: 'white' }}>Full Name</p>
                      ...
                      <p className=" contact-name mt-4 text-left" style={{ color: 'white' }}>Phone Number</p>
                      <p className="text-left ">
                        {' '}
                        <input
                          type="number"
                      ...
                      <p className="text-left mt-4 contact-name " style={{ color: 'white' }}>Message</p>
                      <p className="text-left ">
                        {' '}
                        <input
                          type="text"
                      ...
                      <p className="text-left mt-4 contact-name" style={{ color: 'white' }}>Your Comment</p>
