        ...
        <div className="container-fluid  mt-4 ">
          <div className="row ml-lg-4 d-flex justify-content-between contact-flex">
            <div className="col-lg-5 col-md-12 mt-md-1 ml-lg-4 col-sm-12">
              <p className="text-center  contact-touch" style={{ color: '#474544' }}>Let's get in touch</p>
              ...
              <p className="text-center">
                ...
                <div className="row mt-3">
                  ...
                  <div className="col text-left mt-2">
                    <p>
                      <a href="" className="contact-a" style={{ color: '#474544' }}>
                        care@buildmybody.in
                      </a>
                    </p>
                  </div>
                ...
                <p className="text-center contact-issue mt-4 ml-4" style={{ color: '#474544' }}>
            ...
            <div className="col col-md-12 col-lg-6 mt-md-4 mt-lg-0 mt-sm-4 helo">
              <p className="contact-get text-center mr-5" style={{ color: '#474544' }}> Get in touch</p>
              <div className="contact-info  mt-4 ">
                <div className="contact-full-name ">
                  <div className="row   ">
                    <div className="col  ">
                      <p className="text-left contact-name" style={{ color: '#474544' }}>Full Name</p>
                      ...
                      <p className=" contact-name mt-4 text-left" style={{ color: '#474544' }}>Phone Number</p>
                      <p className="text-left ">
                        {' '}
                        <input
                          type="number"
                      ...
                      <p className="text-left mt-4 contact-name " style={{ color: '#474544' }}>Message</p>
                      <p className="text-left ">
                        {' '}
                        <input
                          type="text"
                      ...
                      <p className="text-left mt-4 contact-name" style={{ color: '#474544' }}>Your Comment</p>
