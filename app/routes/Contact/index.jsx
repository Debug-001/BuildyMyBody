        ...
        <div className="row ml-lg-4 d-flex justify-content-between contact-flex">
          <div className="col  col-lg-5 col-md-12 mt-md-1 ml-lg-4 col-sm-12">
            ...
            <p className="text-center">
              ...
              <p className="text-center contact-issue mt-4 ml-4">
          ...
          <div className="col col-md-12 col-lg-6 mt-md-4 mt-lg-0 mt-sm-4 helo">
            <p className="contact-get text-center mr-5"> Get in touch</p>
            <div className="contact-info  mt-4 ">
              <div className="contact-full-name ">
                <div className="row   ">
                  <div className="col  ">
                    <p className="text-left contact-name">Full Name</p>
                    ...
                    <p className=" contact-name mt-4 text-left">Phone Number</p>
                    <p className="text-left ">
                      {' '}
                      <input
                        type="number"
                    ...
                    <p className="text-left mt-4 contact-name ">Message</p>
                    <p className="text-left ">
                      {' '}
                      <input
                        type="text"
                    ...
                    <p className="text-left mt-4 contact-name">Your Comment</p>
                    ...
                    <button
                      type="button"
                      className="btn mt-1 w-lg-25 contact-button text-light"
                    >
                      Send Message
                    </button>
                  </div>
