    ...
    <>
      <div className="main-div" style={{ background: 'black' }}>
        ...
        <div className="container-fluid">
          <p className="text ml-5 certificate-heading text-light">Certificates</p>
          <div className="row">
            <div className="col ">
          ...
          <div className="row">
            <div className="col ml-5 mt-5">
              <p className=" certificate-heading2 text-light">
        ...
        <div className="container">
          <div className="row flex-sm-column flex-lg-row flex-md-row">
            <div className="col-lg-4 col-md-5 d-flex flex-column ">
              ...
              <button onClick={() => setSelectedCategory('Category1')} className='p-2 mt-5' style={{ background: 'black', color: 'white', cursor: 'pointer' }}>
            ...
            <div className="col mt-5 text-light">
              {data
