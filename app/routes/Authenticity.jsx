...
export const meta = () => {
  return [
    {title: 'BuildMyBody | Verify Your Products'},
    {
      name: 'description',
      content:
        'Verify your fitness products on BuildMyBody using the 14-digit code. Ensure the authenticity of your supplements. Read reviews and testimonials from customers.',
    },
    {
      name: 'keywords',
      content:
        'BuildMyBody, Verify Products, Fitness Supplements, Code Authentication, Reviews, Testimonials, Authenticity',
    },
  ];
};
      ...
      <section id="authenticity-section">
        <div className="container-fluid">
            ...
            <div className="verify-parent">
              <div className="verify-child">
                <form
                  ...
                  className="input-group mb-3 pt-3 pt-lg-5 d-flex flex-column"
                >
                  <input
                    type="text"
                      ...
                      <div className="row d-flex align-items-center mt-2 flex-column">
                        <div className="">
                          <figure>
                            <img
                              src={Authenticityimg}
                              alt="Authenticated Product"
                              className="mt-3"
                            />
                          </figure>
                        </div>
                        <div className="">
                          <p className="h5 font-weight-bolder text-light">
                            {message}
                          </p>
                        </div>
                      </div>
          ...
          <div className="bottom-section">
            <p className="h2 font-weight-bolder text-center pb-5 pt-2">
            ...
            <div className="row pb-5">
              <div className="col-12 col-md-6 col-lg-4 pt-2 text-center">
                ...
                <p className="p-4 font-weight-bolder">
                  Only accept products with an authentication sticker
                </p>
              </div>
