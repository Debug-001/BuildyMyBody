...
export default function Login() {
  ...
  return (
    <>
      <Navbar />
      <div className="main-div mt-1 mt-lg-5 mt-md-5 ">
        <div className="container ">
          <div className="row no-gutters shadow-lg ">
            ...
            <div className="col-md-12 col-lg-7 bg-white p-3 p-lg-5 p-md-5  border border-dark login-border">
              <h3 className="pb-3 text-center login-name">Welcome To BMB!</h3>
              <div className="form-style">
                <Form method="POST">
                  <fieldset>
                    <div className="form-group pb-3 mt-1 mt-lg-4 mt-md-4">
                      <input
                        id="email"
                        className="w-100"
                        name="email"
