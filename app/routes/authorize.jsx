...
export async function loader({request, context}) {
  ...
  const shopID = context.env.PUBLIC_STOREFRONT_ID;
  const tokenRequestUrl = `https://shopify.com/${shopID}/auth/oauth/token`; // Token endpoint
...
async function exchangeAccessToken(session, customerAccountId, origin) {
  const clientId = customerAccountId;
  const customerApiClientId = context.env.PUBLIC_CUSTOMER_ACCOUNT_CLIENT_ID;
