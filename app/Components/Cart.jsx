...
const Accordion = () => {
  ...
  const handleAccordionClick = (index) => {
    ...
    setCopied(false); // Reset copied state when accordion is clicked
  };
  ...
  return (
    <div>
      <p className='pt-4' style={{color:"ff2828"}}>Note: Copy to apply these offers at <span className='font-weight-bolder'>Checkout Page</span> above.</p>
      {/* First Accordion */}
        ...
        <button
          ...
          onClick={() => {
            ...
            handleCopyToClipboard(
              'Protein30: 30% off on All Protein products sitewise',
            );
          }}
        >
      ...
      <div className="section-acc-2">
        <button
          ...
          onClick={() => {
            ...
            handleCopyToClipboard(
              'Another offer description for the second accordion',
            );
          }}
        >
          <MdOutlineLocalOffer size={20} />
