    ...
    return (
        <div className="container" >
            <div className='text-center carousel'>
                <h1 class="font-weight-bold custom-heading3">
                    <em>What's Hot </em>
                </h1>
            ...
            <Slider {...settings}>
                ...
                <NavLink to="/product/insane-labz-psychotic-preworkout" >
                    ...
                    <div className="slider-item p-2 text-dark">
                        ...
                        <div className='mt-1'>
                            <p style={{ fontWeight: '600', fontSize: '1.3rem' }}>Insane Labz Psychotic Preworkout
                            </p>
                ...
                <NavLink to="/product/genuine-enhanced-four" >
                    <div className="slider-item p-2 text-dark">
                        ...
                        <div className='mt-1'>
                            <p style={{ fontWeight: '600', fontSize: '1.3rem' }}>Enhanced Athlete MK-677</p>
                ...
                <NavLink to="/product/mhp-xpel" >
                    <div className="slider-item p-2 text-dark">
                        ...
                        <div className='mt-1'>
                            <p style={{ fontWeight: '600', fontSize: '1.3rem' }}>MHP XPEL, 80 Capsules
                            </p>
                ...
                <NavLink to="/product/genuine-enhanced-two" >
                    <div className="slider-item p-2 text-dark">
                        ...
                        <div className='mt-1'>
                            <p style={{ fontWeight: '600', fontSize: '1.3rem' }}>Enhanced Athlete Blue Ox
                            </p>
                            <p style={{ fontSize: '.9rem' }}>Upto 40% off on Enhanced Athlete Products.</p>
                            <button id='flash-button' className='w-100 p-1'>Shop Now</button>
                        </div>
