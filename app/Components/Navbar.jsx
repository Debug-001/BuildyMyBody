            ...
            <ul className="navbar-nav mt-lg-0">
              {menuItems.map((menuItem, index) => (
                <li
                  ...
                  onMouseLeave={hideSubMenu} // Hide submenu when mouse leaves
                >
                  <NavLink className="nav-link" style={{ color: 'white' }} to={menuItem.link}>
                    {menuItem.text}
                    {menuItem.active && (
                      <span className="sr-only">(current)</span>
                    )}
                  ...
                  {menuItem.text === 'Products' && isSubMenuVisible && (
                    <div className="submenu" style={{ background: 'black', color: 'white' }}>
                      <div className="submenu-content">
                        <div className="row p-4">
                          <div className="col mt-2" >
                            <NavLink to={'/'}>
                          ...
                          <div className="col mt-2">
                            ...
                            <NavLink to={'/'}>
                              <p className='text-center  ' style={{ color: 'white' }}>   <img src={Protein} className='w-50' alt="" /></p>
                            </NavLink>
                            <NavLink to={'/'}>
                              <p className='mt-2 text-center  ' style={{ color: 'white' }}>Mass Gainer</p>
                            </NavLink>
                          ...
                          <div className="col mt-2">
                            ...
                            <NavLink to={'/'}>
                              <p className='mt-1 text-center  ' style={{ color: 'white' }}>Glutamine</p>
                            </NavLink>
                            <NavLink to={'/'}>
                              <p className='mt-1 text-center  ' style={{ color: 'white' }}>Carnitine</p>
                            </NavLink>
