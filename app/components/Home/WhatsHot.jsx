...
export const meta = () => {
  return [
    { title: 'BuildMyBody | Hot Selling Products' },
    {
      name: 'description',
      content:
        'Explore the hottest selling fitness products on BuildMyBody. Find top-quality supplements with exclusive discounts. Shop now for the best deals.',
    },
    {
      name: 'keywords',
      content:
        'BuildMyBody, Hot Selling Products, Fitness Supplements, Exclusive Discounts, Reviews, Testimonials, Shop Now',
    },
  ];
};
