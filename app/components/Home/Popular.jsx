...
export const meta = () => {
  return [
    {title: 'BuildMyBody | Popular in Sports Nutrition'},
    {
      name: 'description',
      content:
        'Explore popular sports nutrition products on BuildMyBody for health and wellness tips.',
    },
    {
      name: 'keywords',
      content:
        'BuildMyBody, Fitness Articles, Health, Wellness, Products, Sports Nutrition',
    },
  ];
};
      ...
      <div className="container-fluid pb-5" id="cgap">
        ...
        <div className="row row-cols-2 row-cols-md-2 row-cols-lg-3">
          {tiles.map((tile) => (
            ...
            >
              <div
                className="certificate-card mt-5 p-0 p-lg-2"
              ...
              >
                ...
                <div className="text-center" id="popular-txt">
                  <p
                    className="pt-2 font-weight-bolder text-dark"
