...
export const meta = () => {
  return [
    {title: 'BuildMyBody | Shop By Brands'},
    {
      name: 'description',
      content:
        'Explore products from popular brands in sports nutrition on BuildMyBody for health and wellness tips.',
    },
    {
      name: 'keywords',
      content:
        'BuildMyBody, Fitness Articles, Health, Wellness, Products, Sports Nutrition, Brands',
    },
  ];
};
