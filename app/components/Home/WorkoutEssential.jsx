...
export const meta = () => {
  return [
    {title: 'BuildMyBody | Popular in Workout Essentials'},
    {
      name: 'description',
      content:
        'Explore popular workout essentials on BuildMyBody. Find top-quality fitness supplements for your workout routine. Shop now for the best deals.',
    },
    {
      name: 'keywords',
      content:
        'BuildMyBody, Workout Essentials, Fitness Supplements, Fat Burner, CLA, Black Mamba, Enhanced Athlete, XPEL, Myodrol HSP',
    },
  ];
};
const WheyEssential = () => {
